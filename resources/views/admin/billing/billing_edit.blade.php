...
<div class="page-header card">
  <div class="card-block">
    <ul class="breadcrumb-title ">
      ...
      <li class="breadcrumb-item"><a href="#!">Edit Billing</a>
      </li>
    </ul>
  </div>
</div>
...
<div class="main-body">
  <div class="page-wrapper">
    ...
    <div class="page-body">
      <div class="row">
        <div class="col-lg-12">
          ...
          <form action="{{ route('billing.edit.submit') }}" method="post" enctype="multipart/form-data">
            @csrf
    ...
    <option value="">Select Company Name</option>
                  {{--
                  <option value="other">Other</option> --}} @foreach ($customer_details as $customer_detail)
                   @if (!empty($customer_detail->company_name))
                  <option value="{{ $edit_billing->select_company_name }} "
                    @if ($edit_billing->select_company_name == $customer_detail->company_name)
                      {{ 'selected' }}
                    @endif
                    >{{ $edit_billing->select_company_name }}</option>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" id="quotation" class="form-control" name="quotation" value="{{$edit_billing->quotation}}" placeholder="Quotation">
                <input type="hidden" class="form-control" name="id" value="{{$edit_billing->id}}" >
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" id="invoice" class="form-control" name="invoice" value="{{$edit_billing->invoice}}" placeholder="Invoice">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <textarea name="services" id="services" rows="5" cols="5" class="form-control" placeholder="Services">{{ $edit_billing->services }}</textarea>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="number" id="total_amount" class="form-control" name="total_amount" value="{{$edit_billing->total_amount}}" placeholder="$ Total Amount"> @if ($errors->has('total_amount'))
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="number" id="paid" class="form-control" name="paid" value="{{$edit_billing->paid}}" placeholder="$ Paid "> @if ($errors->has('paid'))
                <span class="invalid-feedback" role="alert">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="number" id="balance" onClick="SubtractionBy()" class="form-control" name="balance" value="{{$edit_billing->balance}}" placeholder="$ Balance">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <textarea name="remark" id="remark" rows="5" cols="5" class="form-control" placeholder="Remark">{{ $edit_billing->remark }}</textarea>
              </div>
            </div>
